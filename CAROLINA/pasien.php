                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    while ($row = $hasil->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="editpasien.php?edit=<?= $row['idPasien']; ?>" class="btn btn-warning btn-sm">Edit</a> <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">Hapus</button>
